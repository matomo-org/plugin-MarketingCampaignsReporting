...
return [
    'advanced_campaign_reporting.campaign_detector'               => Piwik\DI::autowire(
        '\Piwik\Plugins\MarketingCampaignsReporting\Campaign\CampaignDetector'
    ),
    'advanced_campaign_reporting.uri_parameters.campaign_name'    => Piwik\DI::factory(function (ContainerInterface $c) {
        return [
    ...
    'advanced_campaign_reporting.uri_parameters.campaign_keyword' => Piwik\DI::factory(function (ContainerInterface $c) {
        return [
    ...
    'advanced_campaign_reporting.uri_parameters.campaign_source'  => Piwik\DI::factory(function (ContainerInterface $c) {
        return [
    ...
    'advanced_campaign_reporting.uri_parameters.campaign_medium'  => Piwik\DI::factory(function (ContainerInterface $c) {
        return [
    ...
    'advanced_campaign_reporting.uri_parameters.campaign_content' => Piwik\DI::factory(function (ContainerInterface $c) {
        return [
    ...
    'advanced_campaign_reporting.uri_parameters.campaign_id'      => Piwik\DI::factory(function (ContainerInterface $c) {
        return [
    ...
    'advanced_campaign_reporting.uri_parameters.campaign_group'      => Piwik\DI::factory(function (ContainerInterface $c) {
        return [
    ...
    'advanced_campaign_reporting.uri_parameters.campaign_placement'      => Piwik\DI::factory(function (ContainerInterface $c) {
        return [
